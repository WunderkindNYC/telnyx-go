...
/*
SIMCardGroupsApiService Delete a SIM card group
...
func (a *SIMCardGroupsApiService) SimCardGroupDelete(ctx context.Context, id string) (InlineResponse20037, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/sim_card_groups/{id}"
...
/*
SIMCardGroupsApiService Update a SIM card group
...
/*
SIMCardGroupsApiService Get all SIM card groups
...
func (a *SIMCardGroupsApiService) SimCardGroupsGetAll(ctx context.Context, localVarOptionals *SIMCardGroupsApiSimCardGroupsGetAllOpts) (InlineResponse20036, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sim_card_groups"
...
/*
SIMCardGroupsApiService Create a SIM card group
