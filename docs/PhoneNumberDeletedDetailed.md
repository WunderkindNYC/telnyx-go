...
**CreatedAt** | **string** | ISO 8601 formatted date indicating when the time it took to activate after the purchase. | [optional] [default to null]
...
**PurchasedAt** | **string** | ISO 8601 formatted date indicating the time the request was made to purchase the number. | [optional] [default to null]
